...
public class CourseClassResource {
	...
	@PostMapping
	public ResponseEntity<CourseClass> insert(@RequestBody CourseClass obj) {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<CourseClass> update(@PathVariable Long id, @RequestBody CourseClass obj) {
